...
import { Camera, UserCircle, Star, Heart, Sparkles, Award, Users, Clock } from 'lucide-react';
    ...
    <section className="py-20 bg-gradient-to-b from-rose-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-5 gap-10 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-rose-100 
                          space-y-6 text-lg text-gray-700 h-full">
              <p>
        ...
        <div className="max-w-4xl mx-auto mt-16 text-center">
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-rose-100">
            <div className="mb-4">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="inline-block w-6 h-6 text-rose-500 mr-1" fill="#f43f5e" />
              ))}
            </div>
            <p className="text-xl italic text-gray-700 mb-6">
              "SnuggleShots transformed how I capture moments with my children. I went from taking basic snapshots to creating beautiful images that truly tell our family's story."
            </p>
            <div className="font-bold text-gray-900">— Sarah M., Mother of two</div>
          </div>
        </div>
      </div>
    </section>
