    ...
    >
      <div
        className="inline-flex items-center justify-center w-16 h-16 mb-6 
                      bg-rose-50 rounded-full text-rose-600"
      >
        {icon}
      </div>
    ...
    <section className="py-20 bg-gradient-to-b from-rose-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div
            className="inline-flex items-center gap-2 bg-rose-500/10 backdrop-blur-sm rounded-full 
        ...
        <div className="text-center mt-16">
          <a
            ...
            className="group bg-rose-600 hover:bg-rose-700 text-white px-8 py-4 rounded-full 
                           text-lg font-medium inline-flex items-center gap-3 
                           transform hover:scale-105 transition-all duration-300
                           shadow-lg shadow-rose-200"
          >
            Snap Perfect Photos Each time! From Playtime to Naptime!
